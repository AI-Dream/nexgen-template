<template>
  <div v-if="addressStore.modalShippingCreate" class="modal show d-block" id="addressModal" tamodelex="-1"
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
      <div class="modal-content border-0 overflow-hidden">
        ...
        <div class="modal-header border-0 text-white py-3 d-flex justify-content-between">
          ...
          <button class="mr-5"
            @click="addressStore.closeModal('shipping-create');"><svg-remove></svg-remove></button>
        </div>
...
const { errors, handleSubmit, defineField, resetForm } = useForm<IFormValues>({
...
async function onSuccess(values: any) {
  addressStore.createShippingAddress(values, resetForm)
}
